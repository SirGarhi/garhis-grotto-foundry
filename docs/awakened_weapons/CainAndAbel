...
* Advanced Bladesong (Active Effect)
	* Bladesong can now grant one of the following additional benefits:
		* Resistance to Bludgeoning, Piercing, and Slashing Damage.
		* Resistance to any other Damage Type.
* Overflow Blast (Active Ability) – Bonus Action | Intelligence Modifier Per Awakening | Ranged Weapon Attack
...
* Rapid Blasts – Action (Cantrip) | 1 Durability | Ranged Spell Attacks
	* You fire 6 rays of Eldritch Blast.
	* Each ray must target the same creature.
* Eldritch Burst – Action (Cantrip) | 1 Durability | Dexterity Saving Throw | Half-Damage Save
