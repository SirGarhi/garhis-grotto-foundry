Tiko is an Azer Artificer Armorer with a Great-Old-One Warlock dip
...
### Serrated Blade (Infinity)
* Attacks made with Infinity inflict an additional 2 Slashing damage with every hit.
### Telescoping Shaft (Infinity)
* Attacks made with Infinity on your turn have a range of 10 feet.

## Tier 2
### Mechanized Assistance (Infinity)
* Infinity gains a +1 bonus to Melee Attack and Damage Rolls and it's attacks are considered magical.
...
### Resonating Blade (Harmonic Resonator) | 5 Charges, Upkeep 1
...
* The weapon gains a +1 bonus to Melee Attack Rolls and its attacks are considered magical.
* The weapon deals an additional 2d4 Force Damage on each hit.

## Tier 4
### Overcharged Rotors (Mechanized Assistance)
...
### Harnessed Lightning (Harmonic Resonator) | 6 Charges, Upkeep 1
As a Bonus Action you release aether from the trap to cause the resonator to begin harnessing energy, causing lightning to coalesce and play about it, granting the following benefits:
...
* 10 Charges
	* Wall of Force (the wall must originate within 10 feet of the resonator)
